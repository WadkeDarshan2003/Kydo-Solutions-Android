  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <SessionExpiryWarning />
        {/* Status Bar Spacer - Fixed above all (higher z-index) removed to fix sidebar overlap */}
      ...
      {/* Sidebar */}
      <aside className={`
        fixed inset-y-0 left-0 z-[60] bg-white transform transition-all duration-300 ease-in-out md:relative md:translate-x-0 md:border-r md:border-gray-200
        ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0
        ${isSidebarCollapsed ? 'md:w-20' : 'md:w-64 w-64'}
      `}>
        <div className="h-full flex flex-col relative">
          <div className="status-bar-spacer bg-gray-900 w-full flex-shrink-0 md:hidden"></div>
          <div className="px-6 pb-6 flex items-center justify-between pt-8">
            {!isSidebarCollapsed && (
              <div className="flex items-center gap-3">
                <img src="/kydoicon.png" alt="Kydo" className="w-12 h-12 rounded-lg" />
                <div className="flex flex-col">
                  <span className="text-xl font-bold text-gray-900 leading-none">Kydo</span>
                  <span className="text-xl font-bold text-gray-900 leading-tight">Solutions</span>
                </div>
              </div>
            )}
            {isSidebarCollapsed && (
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden relative">
        ...
        <div className="status-bar-spacer bg-gray-900 w-full flex-shrink-0 fixed top-0 z-50 md:hidden"></div>
        <div className="status-bar-spacer w-full flex-shrink-0 md:hidden bg-transparent"></div>
